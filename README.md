...
```git clone <ссылка на репозиторий в гитхабе> ``` — копирует репозиторий в текущую папку, при этом создается папка с названием того репозитория, все файлы будут в ней
